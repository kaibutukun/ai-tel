...
const FlowEditor = dynamic(
  () => import("@/features/call-flows/editor/components/FlowEditor").then((m) => ({ default: m.FlowEditor })),
  {
    ssr: false,
    loading: () => (
...
interface FlowEditPageProps {
  id: string;
}

export function FlowEditPage({ id }: FlowEditPageProps) {
